...
public class FullScreenImageViewerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            FullScreenImageViewerActivity.this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            FullScreenImageViewerActivity.this.getSupportActionBar().setTitle(activityTitle);
